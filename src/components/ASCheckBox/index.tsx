...
const ASCheckBox: React.FC<ASCheckBoxProps> = (props: ASCheckBoxProps) => {
  ...
  const checkIconStrokeWidth: number | undefined = (
    innerIconStyles as InnerIconStyle
  )?.strokeWidth;
  ...
  let field: FieldInputProps<CheckBoxValue> | undefined;
  let meta: FieldMetaProps<CheckBoxValue> | undefined;
  let helpers: FieldHelperProps<CheckBoxValue> | undefined;
